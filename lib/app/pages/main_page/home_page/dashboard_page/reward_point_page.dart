                ...
                children: [
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              child: SvgPicture.asset(AppAssets.giftSvg,
                                  colorFilter: ColorFilter.mode(
                                      green50, BlendMode.srcIn),
                                  width: 18),
                            ),
                            space(8),
                            Text(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle),
                              alignment: Alignment.center,
                              child: SvgPicture.asset(AppAssets.totalPointSvg,
                                  colorFilter:
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle),
                              alignment: Alignment.center,
                              child: SvgPicture.asset(AppAssets.spentPointSvg,
                                  colorFilter:
                  ...
                  if (data?.rewards == null) ...{
                    Column(
                      ...
                      children: [
                        space(40),
                        SvgPicture.asset(AppAssets.commentsEmptyStateSvg),
                        space(20),
                        Text(
                          appText.noHistpoints,
                          style: style14Bold(),
                        ),
                        space(4),
                        Padding(
                  ...
                  ...List.generate(data?.rewards?.length ?? 0, (index) {
                    return FinancialWidget.historyItem(
                        '',
                        timeStampToDateHour(
                            (data?.rewards?[index].createdAt ?? 0) * 1000),
