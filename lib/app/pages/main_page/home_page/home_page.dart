                    ...
                    SliverToBoxAdapter(
                      child: Column(
                        children: [
                          ...
                          Column(
                            children: [
                              token.isEmpty ? space(10) : space(0),
                              token.isEmpty
                                  ? Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            appText.welcometoaskan,
                                            textAlign: TextAlign.left,
                                            style: style20Bold(),
                                          ),
                                          space(10),
                                          Text(
                                            appText.signintomanage,
                                            textAlign: TextAlign.left,
                                              ...
                                              SizedBox(
                                                ...
                                                child: ElevatedButton(
                                                  ...
                                                  child: Text(
                                                    ...
                                                    style: style16BoldWhite(),
                                                  ),
                                                ),
                                              ),
                                              SizedBox(
                                                width: getSize().width * 0.45,
                                                height:
                                                    getSize().height * 0.045,
                                                child: ElevatedButton(
                                                  onPressed: () {
                          ...
                          if (isLoadingBundleData || bundleData.isNotEmpty) ...{
                            // Bundle
                            Column(
                              children: [
                          ...
                          if (isLoadingBestRatedListData ||
                              bestRatedListData.isNotEmpty) ...{
                            // Best Rated
                            Column(
                              children: [
                          ...
                          if (isLoadingBestSellingListData ||
                              bestSellingListData.isNotEmpty) ...{
                            // Best Selling
                            // Column(
                            //   children: [
                          ...
                          if (isLoadingFreeListData ||
                              freeListData.isNotEmpty) ...{
                            // Free Classes
                            // Column(
                            //   children: [
