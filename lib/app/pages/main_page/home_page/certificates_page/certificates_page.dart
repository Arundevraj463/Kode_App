          ...
          Expanded(
            ...
            isLoadingAchievement
                ...
                : achievementData.isEmpty
                    ? emptyState(AppAssets.certificatesEmptyStateSvg,
                        appText.noCertificates, appText.noCertificatesDesc)
                          ...
                          children: [
                            ...
                            ...List.generate(achievementData.length, (index) {
                              return QuizzesWidget.item(
                                ...
                                nextRoute(CertificatesDetailsPage.pageName,
                                    arguments: [
                                  ...
                                  isMyResult: true,
                                  userGrade: achievementData[index]
                                      .userGrade
                                      .toString(),
                                  status: 'passed',
                                  isShowStatus: false);
                            ...
                            ...List.generate(completionData.length, (index) {
                              return userCard(
                                  ...
                                  parse(completionData[index]
                                      ...
                                      '',
                                  timeStampToDate(
                                      (completionData[index].date ?? 0) * 1000),
                                  '',
                                  '', () {
                                nextRoute(CertificatesDetailsPage.pageName,
                                    arguments: [
