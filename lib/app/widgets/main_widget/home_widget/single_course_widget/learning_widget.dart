...
class LearningWidget {
  static Widget contentPage(List<ContentModel> contents, int courseId,
      Function setState, Function getNewData) {
    if (contents.isEmpty) {
              ...
              child: Column(
                children: [
                  ...
                  AnimatedCrossFade(
                                ...
                                return horizontalChapterItem(
                                  ...
                                  for (var i = 0; i < index; i++) {
                                    if (contents[i].checkAllContentsPass == 1) {
                                      for (var j = 0;
                                          j < (contents[i].items?.length ?? 0);
                                          j++) {
                                        if (contents[i].items?[j].authHasRead ==
                                            false) {
                                          closeSnackBar();
                                          showSnackBar(ErrorEnum.error,
                                              appText.accessDenied,
                                              desc: appText.accessDeniedDesc);
                                          return;
                                        }
                                      }
                                    }
                                  ...
                                  if (contents[index].checkAllContentsPass ==
                                      1) {}
                                  ...
                                  if (contents[index].items![i].type ==
                                    ...
                                    await nextRoute(SingleContentPage.pageName,
                                        arguments: [
                      ...
                      crossFadeState: (contents[index].isOpen)
        ...
        children: [
          ...
          ...List.generate(courseData!.certificates.length, (i) {
            return horizontalChapterItem(
                ...
                timeStampToDate(
                    (courseData.certificates[i].createdAt ?? 0) * 1000), () {
  ...
  static Widget forum(ForumModel? forumData, Function(int index) changeState,
        ...
        child: forumData?.forums?.isEmpty ?? true
            ? Center(
                ...
                child: emptyState(AppAssets.commentsEmptyStateSvg,
                    appText.noQuestion, appText.noQuestionDesc),
              ))
            : Column(
                ...
                children: [
                      ...
                      child: Row(
                        children: [
                          dashboardInfoBox(
                              ...
                              forumData?.questionsCount?.toString() ?? '-',
                              appText.questions,
                              () {},
                              height: 145),
                          space(0, width: 16),
                          dashboardInfoBox(
                              ...
                              forumData?.resolvedCount?.toString() ?? '-',
                              appText.resolved,
                              () {},
                              height: 145),
                          space(0, width: 16),
                          dashboardInfoBox(
                              ...
                              forumData?.openQuestionsCount?.toString() ?? '-',
                              appText.openQuestions,
                              () {},
                              height: 145),
                          space(0, width: 16),
                          dashboardInfoBox(
                              green50,
                              AppAssets.chatMoreSvg,
                              forumData?.commentsCount?.toString() ?? '-',
                              appText.answers,
                              () {},
                              height: 145),
                          space(0, width: 16),
                          dashboardInfoBox(
                              ...
                              forumData?.activeUsersCount?.toString() ?? '-',
                              appText.activeUsers,
                              () {},
                              height: 145),
                        ],
                  ...
                  SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...List.generate(forumData?.forums?.length ?? 0,
                                (index) {
                              return forumQuestionItem(
                                  forumData!.forums![index], () {
                                changeState(index);
                              });
                            }),
                            space(120),
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              space(16),
              input(searchController, searchNode, appText.search,
                  isBorder: true, iconPathLeft: AppAssets.searchSvg),
              space(24),
              button(
                  onTap: () {
                    if (searchController.text.trim().isNotEmpty) {
                      backRoute();
                      nextRoute(SearchForumPage.pageName,
                          arguments: [searchController.text.trim(), courseId]);
                    }
                  },
                  width: getSize().width,
                  height: 52,
  ...
  static Future forumOptionSheet(Can can, bool isPin, Function onTapPin,
      Function onTapMarkAsResolved, Function onTapEdit) async {
              ...
              if (can.pin ?? false) ...{
                ...
                GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      SvgPicture.asset(AppAssets.bookmarkLineSvg,
          ...
          child: StatefulBuilder(builder: (context, state) {
            return Column(
              ...
              children: [
                ...
                space(16),
                input(titleController, titleNode, appText.title,
                ...
                Row(
                  children: [
                    button(
                        onTap: () async {
                          final imagePicker.ImagePicker picker =
                          ...
                          if (image != null) {
                            ...
                            String address =
                                '${appDocDir.path}/${DateTime.now().millisecond}.jpg';
  ...
  static Future forumReplaySheet(Forums? question,
      {bool isEdit = false, ForumAnswerModel? answer}) async {
    TextEditingController descController = TextEditingController();
    FocusNode descNode = FocusNode();
                ...
                child: button(
                    onTap: () async {
                      if (isEdit) {
                        ...
                        bool res = await ForumService.updateAnswer(
                            answer!.id!, descController.text.trim());
                        ...
                        bool res = await ForumService.setAnswer(
                            question!.id!, descController.text.trim());
