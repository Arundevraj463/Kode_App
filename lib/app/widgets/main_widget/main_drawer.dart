                    ...
                    Expanded(
                      ...
                      child: Column(
                        children: [
                          ...
                          // }),
                          if (token.isNotEmpty)
                            menuItem(appText.deleteaccount, AppAssets.deleteSvg,
                                () {
                              if (hasAccess(canRedirect: false)) {
  ...
  void _showDeleteConfirmationDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(
            appText.confirmdelete,
            style: style20Bold().copyWith(color: Colors.black),
          ),
          content: Text(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () async {
                ...
                bool result = await UserService.deleteuseraccount();
                if (result) {
                  showSnackBar(ErrorEnum.success, appText.accdeletesuccess);
                  drawerController.hideDrawer();
                  ...
                  showSnackBar(ErrorEnum.alert, appText.accdeletefail);
                }
              },
              child: Text(
                appText.delete,
                style: style16Regular().copyWith(color: Colors.red),
              ),
            ),
          ],
        );
